...
public class reporteAsistencias extends javax.swing.JFrame {
    ...
    JTable tabla = new JTable(dmtpersonal, cols);
    ...
    public void mostrardatos() {
        ...
        dmtpersonal.addColumn("ASISTENCIA");
        tra.setModel(dmtpersonal);

        String[] tablapersonal = new String[2];
        try {
            Statement stp = c.createStatement();
            ResultSet rs = stp.executeQuery("SELECT * FROM fecha");
            while (rs.next()) {
                tablapersonal[0] = rs.getString(3);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/report_add.png"))); // NOI18N
        jLabel1.setText("REPORTE DE ASISTENCIA");
    ...
    private javax.swing.JTable tra;
